...
let allowedOrigins = ['http://localhost:8080','https://cinemapp-backend.herokuapp.com/','http://localhost:1234', 'http://localhost:4200', 'https://mihocsaszilard-cinemapp.netlify.app'];
app.use(cors({
